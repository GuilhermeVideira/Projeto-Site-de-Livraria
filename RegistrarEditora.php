...
$insert = "INSERT INTO `tb_editora` (`cd_editora`, `nm_editora`, `nm_endereco`, `nr_endereco`, `nm_bairro`, `nr_telefone`, `nm_gerente`, `nr_senha`) VALUES (NULL, '$nome', '$endereco', '$numeroendereco', '$bairro', '$telefone', '$gerente', '$senha')";
