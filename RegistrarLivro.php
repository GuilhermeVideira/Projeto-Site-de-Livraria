...
$isbn = $_POST['cd_isbn'];
$nome = $_POST['nm_livro'];
$autor = $_POST['nm_autor'];
$assunto = $_POST['nm_assunto'];
$quantidade = $_POST['nr_quantidade'];
$editora = $_POST['nr_editora'];
$data = $_POST['dt_livro'];

$insert = "INSERT INTO `tb_livro` (`cd_isbn`, `nm_livro`, `nm_autor`, `ds_assunto`, `qt_estoque`, `dt_livro`, `fk_cd_editora`) VALUES ('$isbn', '$nome', '$autor', '$assunto', '$quantidade', '$data', '$editora')";
        ...
        <nav class="navbar col-12 m-auto position-fixed navbar-expand-lg navbar-dark bg-primary" style="z-index:999;">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="./TelaCadastroLivro.html"> Histórico de Livros </a>
              </li>
              <li class="nav-item">
